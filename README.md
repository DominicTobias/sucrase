...
**Note:** This is a fork of sucrase which only compiles an ESM build with .js extension due to having problems running it in Gatsby, Create-React-App etc. It just makes tiny change to `build.ts`.
